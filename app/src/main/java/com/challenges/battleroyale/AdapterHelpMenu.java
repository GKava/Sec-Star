...
public class AdapterHelpMenu extends RecyclerView.Adapter<AdapterHelpMenu.ViewHolder>  {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterHelpMenu.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public AdapterHelpMenu.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, final int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_card_help, parent, false);

        RecyclerView.LayoutParams lp = (RecyclerView.LayoutParams) view.getLayoutParams();
        view.setLayoutParams(lp);

        AdapterHelpMenu.ViewHolder viewHolder = new AdapterHelpMenu.ViewHolder(view);
